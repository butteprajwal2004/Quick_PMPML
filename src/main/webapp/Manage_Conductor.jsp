...
<body>
  ...
  <form name="form" action="add_conductor.jsp"  method="post"  >
    ...
    <label for="gender">Gender:</label>
        ...
        <br>
        <center> <input type="submit" value="Add Conductor"></center>
        <br>
...
Connection con = ConnectionProvider.getCon();
 PreparedStatement  ps = con.prepareStatement("SELECT * FROM conductor");
 ResultSet rs = ps.executeQuery();
    ...
    out.println("<th>Conductor Name</th>");
    ...
    out.println("<th>Delete Conductor</th>");
    out.println("</tr>");
    while (rs.next()) {
        out.println("<tr>");
